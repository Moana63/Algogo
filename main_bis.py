...
def calc_score(input ,line_index = line_index, len_file = len_file, len_seq = len_seq, k = k):
...
def write_ordered_kmers(input, output):
    score_list = calc_score()
    with open(input) as f:
